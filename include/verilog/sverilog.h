...
*/
extern ast_node_attributes * ast_new_attributes(
    ast_identifier name, 
...
*/
extern void ast_append_attribute(ast_node_attributes * parent, 
...
*/
extern ast_concatenation * ast_new_concatenation(ast_concatenation_type type,
...
@param [in] type - What sort of values are being concatenated?
*/
extern ast_concatenation * ast_new_empty_concatenation(ast_concatenation_type type);
...
*/
extern void         ast_extend_concatenation(ast_concatenation * element,
                                             ast_expression * repeat,
                                             void * data);
...
@brief Creates and returns a new @ref ast_lvalue pointer, with the data type
       ...
       @ref VAR_IDENTIFIER.
*/
extern ast_lvalue * ast_new_lvalue_id(ast_lvalue_type type, ast_identifier id);
...
*/
extern ast_lvalue * ast_new_lvalue_concat(ast_lvalue_type type, ast_concatenation*id);
...
*/
extern ast_function_call * ast_new_function_call(ast_identifier  id,
...
*/
extern char * ast_primary_tostring(
    ast_primary * p
);
...
*/
extern ast_primary * ast_new_constant_primary(ast_primary_value_type type);

/*!
@brief Creates a new AST primary wrapper around a function call.
@param [in] call - The AST node representing a function call.
*/
extern ast_primary * ast_new_primary_function_call(ast_function_call * call);
...
@param [in] type - Self explanatory
*/
extern ast_primary * ast_new_primary(ast_primary_value_type type);
...
@param [in] type - Self explanatory
*/
extern ast_primary * ast_new_module_path_primary(ast_primary_value_type type);
...
extern char * ast_operator_tostring(ast_operator op);
...
*/
extern char * ast_expression_tostring(
    ast_expression * exp
);
...
*/
extern ast_expression * ast_new_expression_primary(ast_primary * p);
...
*/
extern ast_expression * ast_new_binary_expression(ast_expression * left,
...
@param [in] constant - Is this a constant expression we can simplify?
*/
extern ast_expression * ast_new_unary_expression(ast_primary    * operand,
                                          ast_operator     operation,
                                          ast_node_attributes * attr,
                                          ast_boolean       constant);
...
*/
extern ast_expression * ast_new_range_expression(ast_expression * left,
                                          ast_expression * right);
...
*/
extern ast_expression * ast_new_index_expression(ast_expression * left);

/*!
@brief Creates a new string expression.
@param [in] string - The string. Duh.
*/
extern ast_expression * ast_new_string_expression(ast_string string);
...
*/
extern ast_expression * ast_new_conditional_expression(ast_expression * condition,
...
*/
extern ast_expression * ast_new_mintypmax_expression(ast_expression * min,
                                              ast_expression * typ,
                                              ast_expression * max);
...
*/
extern ast_path_declaration * ast_new_path_declaration(ast_path_declaration_type type);

/*!
@brief Creates and returns a pointer to a new simple parallel path declaration.
*/
extern ast_simple_parallel_path_declaration * ast_new_simple_parallel_path_declaration
(
    ast_identifier      input_terminal,
    ast_operator        polarity,
    ast_identifier      output_terminal,
...
*/
extern ast_simple_full_path_declaration * ast_new_simple_full_path_declaration
(
    ast_list        *   input_terminals,
    ast_operator        polarity,
    ast_list        *   output_terminals,
...
*/
extern ast_edge_sensitive_parallel_path_declaration * 
...
*/
extern ast_edge_sensitive_full_path_declaration * 
...
*/
extern ast_task_enable_statement * ast_new_task_enable_statement(
...
*/
extern ast_loop_statement * ast_new_forever_loop_statement(
...
continue or break.
*/
extern ast_loop_statement * ast_new_for_loop_statement(
...
continue or break.
*/
extern ast_loop_statement * ast_new_generate_loop_statement(
...
continue or break.
*/
extern ast_loop_statement * ast_new_while_loop_statement(
    ast_statement  * inner_statement,
    ast_expression * continue_condition
);
...
continue or break.
*/
extern ast_loop_statement * ast_new_repeat_loop_statement(
    ast_statement  * inner_statement,
    ast_expression * continue_condition
);
...
*/
extern ast_case_item * ast_new_case_item(ast_list      * conditions,
                                  ast_statement * body);
...
*/
extern ast_case_statement * ast_new_case_statement(ast_expression * expression,
                                            ast_list       * cases,
...
*/
extern ast_conditional_statement * ast_new_conditional_statement(
...
*/
extern ast_if_else * ast_new_if_else(
...
*/
extern void  ast_extend_if_else(
...
typedef struct ast_delay_ctrl_t{
    ...
    union{
        struct ast_delay_value_t * value;
...
*/
extern ast_wait_statement * ast_new_wait_statement(
...
*/
extern ast_event_expression * ast_new_event_expression(
...
sub-expressions.
*/
extern ast_event_expression * ast_new_event_expression_sequence(
...
*/
extern ast_event_control * ast_new_event_control(
    ast_event_control_type type,
    ast_event_expression * expression
);
...
*/
extern ast_delay_ctrl * ast_new_delay_ctrl_value(struct ast_delay_value_t * value);

/*!
@brief creates and returns a new delay control statement.
*/
extern ast_delay_ctrl * ast_new_delay_ctrl_mintypmax(
    ast_expression * mintypmax 
);
...
*/
extern ast_timing_control_statement * ast_new_timing_control_statement_delay(
    ast_timing_control_statement_type   type,
    ast_statement                     * statement,
...
@brief Creates and returns a new timing control statement node.
*/
extern ast_timing_control_statement * ast_new_timing_control_statement_event(
    ast_timing_control_statement_type   type,
    ast_expression                    * repeat,
    ast_statement                     * statement,
    ast_event_control                 * event_ctrl
...
extern ast_disable_statement * ast_new_disable_statement(ast_identifier   id);
...
*/
extern ast_statement_block * ast_new_statement_block(
    ast_block_type   type,
    ast_identifier   block_identifier,
    ast_list       * declarations,
    ast_list       * statements
...
*/
extern ast_single_assignment * ast_new_single_assignment(
    ast_lvalue         * lval,          //!< The thing being assigned to.
    ast_expression     * expression //!< The value it takes on.
);
...
*/
extern ast_assignment * ast_new_hybrid_assignment(
...
@brief Creates a new hybrid assignment of the specified type.
*/
extern ast_assignment * ast_new_hybrid_lval_assignment(
...
*/
extern ast_assignment * ast_new_blocking_assignment(
...
*/
extern ast_assignment * ast_new_nonblocking_assignment(
    ast_lvalue * lval,  //!< The net/variable being assigned to.
...
*/
extern ast_assignment * ast_new_continuous_assignment(
...
*/
extern ast_statement * ast_new_statement(
    ast_node_attributes * attr,
    ast_boolean         is_function_statement,
    void             *  data,
    ast_statement_type  type
...
*/
extern ast_pulse_control_specparam * ast_new_pulse_control_specparam(
    ast_expression * reject_limit,
    ast_expression * error_limit
);
...
*/
extern ast_range * ast_new_range(
    ast_expression * upper,
    ast_expression * lower
);
...
extern ast_udp_initial_statement * ast_new_udp_initial_statement(
    ast_identifier   output_port,
    ast_number     * initial_value
);
...
extern ast_udp_body * ast_new_udp_sequential_body(
...
extern ast_udp_body * ast_new_udp_combinatoral_body(
    ast_list                  * combinatorial_entries
);

//! Creates a new combinatorial entry for a UDP node.
extern ast_udp_combinatorial_entry * ast_new_udp_combinatoral_entry(
    ast_list * input_levels,
    ast_udp_next_state output_symbol
);

//! Creates a new sequntial body entry for a UDP node.
extern ast_udp_sequential_entry * ast_new_udp_sequential_entry(
...
*/
extern ast_udp_port * ast_new_udp_port(
    ast_port_direction    direction,
...
@returns A pointer to the new port
*/
extern ast_udp_port * ast_new_udp_input_port(
...
*/
extern ast_udp_declaration * ast_new_udp_declaration(
    ast_node_attributes * attributes,
    ast_identifier        identifier,
    ast_list            * ports,
    ast_udp_body        * body
...
*/
extern ast_udp_instance * ast_new_udp_instance(
    ast_identifier        identifier,
    ast_range           * range,
    ast_lvalue          * output,
    ast_list            * inputs
...
*/
extern ast_udp_instantiation * ast_new_udp_instantiation(
    ast_list            * instances,
    ast_identifier        identifier, //!< The UDP being instanced
    ast_drive_strength  * drive_strength,
    ast_delay2          * delay
...
extern ast_generate_block * ast_new_generate_block(
    ast_identifier   identifier,
    ast_list       * generate_items
);
...
*/
extern ast_statement * ast_new_generate_item(
    ast_statement_type type,
    void    *          construct
);
...
parameters.
*/
extern ast_module_instantiation * ast_new_module_instantiation(
...
*/
extern ast_module_instance * ast_new_module_instance(
    ast_identifier          instance_identifier,
    ast_list              * port_connections
);
...
*/
extern ast_port_connection * ast_new_named_port_connection(
    ast_identifier   port_name,
    ast_expression * expression
);
...
extern ast_switch_gate * ast_new_switch_gate_d3(
    ast_switchtype type,
    ast_delay3     * delay
);

//! Instances a new switch type with a delay2.
extern ast_switch_gate * ast_new_switch_gate_d2(
    ast_switchtype type,
    ast_delay2     * delay
);
...
extern ast_pull_strength * ast_new_pull_stregth(
    ast_primitive_strength strength_1,
    ast_primitive_strength strength_2
);
...
extern ast_primitive_pull_strength * ast_new_primitive_pull_strength(
    ast_pull_direction       direction,
    ast_primitive_strength   strength_1,
    ast_primitive_strength   strength_0
);
...
extern ast_n_input_gate_instances * ast_new_n_input_gate_instances(
    ast_gatetype_n_input    type,
    ast_delay3            * delay,
    ast_drive_strength    * drive_strength,
    ast_list              * instances
...
extern ast_enable_gate_instances * ast_new_enable_gate_instances(
    ast_gatetype_n_input    type,
    ast_delay3            * delay,
    ast_drive_strength    * drive_strength,
    ast_list              * instances
...
*/
extern ast_n_output_gate_instance * ast_new_n_output_gate_instance(
    ast_identifier                name,
    ast_list                    * outputs,
    ast_expression              * input
);
...
*/
extern ast_n_output_gate_instances * ast_new_n_output_gate_instances(
    ast_n_output_gatetype         type,
    ast_delay2                  * delay,
    ast_drive_strength          * drive_strength,
    ast_list                    * instances
...
*/
extern ast_pass_enable_switches * ast_new_pass_enable_switches(
    ast_pass_enable_switchtype    type,
    ast_delay2                  * delay,
    ast_list                    * switches 
);
...
*/
extern ast_pass_enable_switch * ast_new_pass_enable_switch(
    ast_identifier      name,
    ast_lvalue        * terminal_1,
    ast_lvalue        * terminal_2,
    ast_expression    * enable
...
extern ast_pull_gate_instance * ast_new_pull_gate_instance(
    ast_identifier      name,
    ast_lvalue        * output_terminal
);

/*! @brief A single pass transistor instance.*/
extern ast_pass_switch_instance * ast_new_pass_switch_instance(
    ast_identifier      name,
    ast_lvalue        * terminal_1,
    ast_lvalue        * terminal_2
);
...
extern ast_n_input_gate_instance * ast_new_n_input_gate_instance(
    ast_identifier      name,
    ast_list          * input_terminals,
    ast_lvalue        * output_terminal
);
...
extern ast_enable_gate_instance * ast_new_enable_gate_instance(
    ast_identifier      name,
    ast_lvalue        * output_terminal,
    ast_expression    * enable_terminal,
    ast_expression    * input_terminal
...
extern ast_mos_switch_instance * ast_new_mos_switch_instance(
    ast_identifier      name,
    ast_lvalue        * output_terminal,
    ast_expression    * enable_terminal,
    ast_expression    * input_terminal
...
extern ast_cmos_switch_instance * ast_new_cmos_switch_instance(
    ast_identifier      name,
    ast_lvalue        * output_terminal,
    ast_expression    * ncontrol_terminal,
    ast_expression    * pcontrol_terminal,
...
*/
extern ast_switches * ast_new_switches(ast_switch_gate * type, ast_list * switches);
...
is returned.
*/
extern ast_gate_instantiation * ast_new_gate_instantiation(ast_gate_type type);
...
*/
extern ast_delay_value * ast_new_delay_value(
    ast_delay_value_type type,
    void * data
);
...
*/
extern ast_delay3 * ast_new_delay3(
    ast_delay_value * min,
    ast_delay_value * avg,
    ast_delay_value * max
);
...
*/
extern ast_delay2 * ast_new_delay2(
    ast_delay_value * min,
    ast_delay_value * max
);
...
*/
extern ast_port_declaration * ast_new_port_declaration(
...
*/
extern ast_list * ast_new_net_declaration(
...
in the original type declaration object.
*/
extern ast_list * ast_new_reg_declaration(
    ast_type_declaration * type_dec
);
...
in the original type declaration object.
*/
extern ast_list * ast_new_var_declaration(
    ast_type_declaration * type_dec
);
...
initially be false.
*/
extern ast_type_declaration * ast_new_type_declaration(ast_declaration_type type);
...
*/
extern ast_parameter_declarations * ast_new_parameter_declarations(
    ast_list        * assignments,
...
*/
extern ast_block_reg_declaration * ast_new_block_reg_declaration(
    ast_boolean   is_signed,    //!< Do they represent signed values?
    ast_range   * range,        //!< Are these vectors of registers?
    ast_list    * identifiers   //!< list of reg names with same properties.
);
...
*/
extern ast_block_item_declaration * ast_new_block_item_declaration(
...
*/
extern ast_range_or_type * ast_new_range_or_type(ast_boolean is_range);
...
*/
extern ast_function_declaration * ast_new_function_declaration(
    ast_boolean         automatic,         //!< Is automatic?
    ast_boolean         is_signed,         //!< Is the returned value signed?
    ast_boolean         function_or_block, //!< IFF true statements is list of function_item_declaration else list of block_item_declaration.
    ast_range_or_type  *rot,               //!< Range or type.
...
argument.
*/
extern ast_task_port * ast_new_task_port(
    ast_port_direction direction,   //!< Input or output to the port.
    ast_boolean        reg,         //!< Is is a registered value?
    ast_boolean        is_signed,   //!< Does it represent a signed value?
    ast_range        * range,       //!< Bit or item range for arrays.
...
*/
extern ast_function_item_declaration * ast_new_function_item_declaration();
...
@brief Creates and returns a new task declaration statement.
*/
extern ast_task_declaration * ast_new_task_declaration(
    ast_boolean         automatic,      //!< Automatic iff TRUE
    ast_identifier      identifier,     //!< The task name.
    ast_list        *   ports,          //!< Arguments to the task.
    ast_list        *   declarations,   //!< Internal variable declarations.
...
*/
extern ast_module_item * ast_new_module_item(
    ast_node_attributes * attributes,
    ast_module_item_type  type
);
...
*/
extern ast_statement_block * ast_extract_statement_block(
    ast_statement_type  type,
    ast_statement     * body
);
...
*/
extern ast_module_declaration * ast_new_module_declaration(
    ast_node_attributes * attributes,
    ast_identifier        identifier,
    ast_list            * parameters,
    ast_list            * ports,
...
array.
*/
extern char * ast_identifier_tostring(ast_identifier id);

/*!
@brief Acts like strcmp but works on ast identifiers.
*/
extern int ast_identifier_cmp(
    ast_identifier a,
    ast_identifier b
);
...
*/
extern ast_identifier ast_new_identifier(
...
*/
extern ast_identifier ast_new_system_identifier(
    char         * identifier,  //!< String text of the identifier.
    unsigned int   from_line    //!< THe line the idenifier came from.
);
...
*/
extern ast_identifier ast_append_identifier(
...
*/
extern void ast_identifier_set_range(
    ast_identifier    id,
    ast_range       * range
);
...
*/
extern void ast_identifier_set_index(
    ast_identifier    id,
...
*/
extern ast_config_rule_statement * ast_new_config_rule_statement(
    ast_boolean    is_default,
    ast_identifier clause_1,    //!< The first grammar clause.
    ast_identifier clause_2     //!< The second grammar clause.
);
...
*/
extern ast_config_declaration * ast_new_config_declaration(
    ast_identifier  identifier,
    ast_identifier  design_statement,
    ast_list      * rule_statements
);
...
*/
extern ast_library_declaration * ast_new_library_declaration(
    ast_identifier  identifier,
    ast_list      * file_paths,
    ast_list      * incdirs
);
...
extern ast_library_descriptions * ast_new_library_description(
    ast_library_item_type type
);
...
set manually.
*/
extern ast_source_item * ast_new_source_item(ast_source_item_type type);
...
*/
extern verilog_source_tree * verilog_new_source_tree();
...
*/
extern void verilog_free_source_tree(
