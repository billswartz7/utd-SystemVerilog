...
*/
extern void       ast_list_free(ast_list * list);

/*!
@brief Adds a new item to the end of a linked list.
*/
extern void       ast_list_append(ast_list * list, void * data);


/*!
@brief Adds a new item to the front of a linked list.
*/
extern void       ast_list_preappend(ast_list * list, void * data);
...
as the correct type.
*/
extern void *    ast_list_get(ast_list * list, unsigned int item);

/*!
@brief Removes the i'th item from a linked list.
*/
extern void      ast_list_remove_at(ast_list * list, unsigned int i);
...
*/
extern ast_list *    ast_list_concat(ast_list * head, ast_list * tail);
...
*/
extern ast_stack * ast_stack_new();

/*!
@brief Free the stack, but not it's contents
*/
extern void ast_stack_free(ast_stack * stack);
...
extern ast_hashtable_result ast_hashtable_get(
