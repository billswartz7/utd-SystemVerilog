...
*/
extern void verilog_resolve_modules(
...
exists.
*/
extern ast_module_declaration * verilog_find_module_declaration(
    verilog_source_tree * source,
...
*/
extern ast_list * verilog_module_get_children(
...
*/
extern ast_hashtable * verilog_modules_get_children(
    verilog_source_tree * source
);
