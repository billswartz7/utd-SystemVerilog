...
//
//       Instance Name:              tsmc16_1rw_256_64b
//       Words:                      256
//       Bits:                       64
//       Mux:                        2
//       Drive:                      6
...
//       
//       Creation Date:  Wed Sep 12 16:17:28 2018
//       Version: 	r1p0
//
...
module datapath_latch_tsmc16_1rw_256_64b (CLK,Q_update,D_update,SE,SI,D,DFTRAMBYP,mem_path,XQ,Q);
...
endmodule // datapath_latch_tsmc16_1rw_256_64b
...
`ifdef POWER_PINS
module tsmc16_1rw_256_64b (VDDCE, VDDPE, VSSE, Q, CLK, CEN, GWEN, A, D, STOV, EMA,
    EMAW, EMAS, RET1N);
`else
module tsmc16_1rw_256_64b (Q, CLK, CEN, GWEN, A, D, STOV, EMA, EMAW, EMAS, RET1N);
`endif
...
`endif
   ...
   `ifdef ARM_FAULT_MODELING
     tsmc16_1rw_256_64b_error_injection u1(.CLK(CLK_), .Q_out(Q_), .A(A_int), .CEN(CEN_int), .GWEN(GWEN_int), .WEN(GWEN_int), .Q_in(Q_int));
  `else
...
`endif
  ...
  datapath_latch_tsmc16_1rw_256_64b uDQ0 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(1'b0), .D(D_int_bmux[0]), .DFTRAMBYP(1'b0), .mem_path(mem_path[0]), .XQ(XQ|XD_int[0]|1'b0), .Q(Q_int[0]));
  datapath_latch_tsmc16_1rw_256_64b uDQ1 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[0]), .D(D_int_bmux[1]), .DFTRAMBYP(1'b0), .mem_path(mem_path[1]), .XQ(XQ|XD_int[1]), .Q(Q_int[1]));
  datapath_latch_tsmc16_1rw_256_64b uDQ2 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[1]), .D(D_int_bmux[2]), .DFTRAMBYP(1'b0), .mem_path(mem_path[2]), .XQ(XQ|XD_int[2]), .Q(Q_int[2]));
  datapath_latch_tsmc16_1rw_256_64b uDQ3 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[2]), .D(D_int_bmux[3]), .DFTRAMBYP(1'b0), .mem_path(mem_path[3]), .XQ(XQ|XD_int[3]), .Q(Q_int[3]));
  datapath_latch_tsmc16_1rw_256_64b uDQ4 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[3]), .D(D_int_bmux[4]), .DFTRAMBYP(1'b0), .mem_path(mem_path[4]), .XQ(XQ|XD_int[4]), .Q(Q_int[4]));
  datapath_latch_tsmc16_1rw_256_64b uDQ5 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[4]), .D(D_int_bmux[5]), .DFTRAMBYP(1'b0), .mem_path(mem_path[5]), .XQ(XQ|XD_int[5]), .Q(Q_int[5]));
  datapath_latch_tsmc16_1rw_256_64b uDQ6 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[5]), .D(D_int_bmux[6]), .DFTRAMBYP(1'b0), .mem_path(mem_path[6]), .XQ(XQ|XD_int[6]), .Q(Q_int[6]));
  datapath_latch_tsmc16_1rw_256_64b uDQ7 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[6]), .D(D_int_bmux[7]), .DFTRAMBYP(1'b0), .mem_path(mem_path[7]), .XQ(XQ|XD_int[7]), .Q(Q_int[7]));
  datapath_latch_tsmc16_1rw_256_64b uDQ8 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[7]), .D(D_int_bmux[8]), .DFTRAMBYP(1'b0), .mem_path(mem_path[8]), .XQ(XQ|XD_int[8]), .Q(Q_int[8]));
  datapath_latch_tsmc16_1rw_256_64b uDQ9 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[8]), .D(D_int_bmux[9]), .DFTRAMBYP(1'b0), .mem_path(mem_path[9]), .XQ(XQ|XD_int[9]), .Q(Q_int[9]));
  datapath_latch_tsmc16_1rw_256_64b uDQ10 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[9]), .D(D_int_bmux[10]), .DFTRAMBYP(1'b0), .mem_path(mem_path[10]), .XQ(XQ|XD_int[10]), .Q(Q_int[10]));
  datapath_latch_tsmc16_1rw_256_64b uDQ11 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[10]), .D(D_int_bmux[11]), .DFTRAMBYP(1'b0), .mem_path(mem_path[11]), .XQ(XQ|XD_int[11]), .Q(Q_int[11]));
  datapath_latch_tsmc16_1rw_256_64b uDQ12 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[11]), .D(D_int_bmux[12]), .DFTRAMBYP(1'b0), .mem_path(mem_path[12]), .XQ(XQ|XD_int[12]), .Q(Q_int[12]));
  datapath_latch_tsmc16_1rw_256_64b uDQ13 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[12]), .D(D_int_bmux[13]), .DFTRAMBYP(1'b0), .mem_path(mem_path[13]), .XQ(XQ|XD_int[13]), .Q(Q_int[13]));
  datapath_latch_tsmc16_1rw_256_64b uDQ14 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[13]), .D(D_int_bmux[14]), .DFTRAMBYP(1'b0), .mem_path(mem_path[14]), .XQ(XQ|XD_int[14]), .Q(Q_int[14]));
  datapath_latch_tsmc16_1rw_256_64b uDQ15 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[14]), .D(D_int_bmux[15]), .DFTRAMBYP(1'b0), .mem_path(mem_path[15]), .XQ(XQ|XD_int[15]), .Q(Q_int[15]));
  datapath_latch_tsmc16_1rw_256_64b uDQ16 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[15]), .D(D_int_bmux[16]), .DFTRAMBYP(1'b0), .mem_path(mem_path[16]), .XQ(XQ|XD_int[16]), .Q(Q_int[16]));
  datapath_latch_tsmc16_1rw_256_64b uDQ17 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[16]), .D(D_int_bmux[17]), .DFTRAMBYP(1'b0), .mem_path(mem_path[17]), .XQ(XQ|XD_int[17]), .Q(Q_int[17]));
  datapath_latch_tsmc16_1rw_256_64b uDQ18 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[17]), .D(D_int_bmux[18]), .DFTRAMBYP(1'b0), .mem_path(mem_path[18]), .XQ(XQ|XD_int[18]), .Q(Q_int[18]));
  datapath_latch_tsmc16_1rw_256_64b uDQ19 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[18]), .D(D_int_bmux[19]), .DFTRAMBYP(1'b0), .mem_path(mem_path[19]), .XQ(XQ|XD_int[19]), .Q(Q_int[19]));
  datapath_latch_tsmc16_1rw_256_64b uDQ20 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[19]), .D(D_int_bmux[20]), .DFTRAMBYP(1'b0), .mem_path(mem_path[20]), .XQ(XQ|XD_int[20]), .Q(Q_int[20]));
  datapath_latch_tsmc16_1rw_256_64b uDQ21 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[20]), .D(D_int_bmux[21]), .DFTRAMBYP(1'b0), .mem_path(mem_path[21]), .XQ(XQ|XD_int[21]), .Q(Q_int[21]));
  datapath_latch_tsmc16_1rw_256_64b uDQ22 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[21]), .D(D_int_bmux[22]), .DFTRAMBYP(1'b0), .mem_path(mem_path[22]), .XQ(XQ|XD_int[22]), .Q(Q_int[22]));
  datapath_latch_tsmc16_1rw_256_64b uDQ23 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[22]), .D(D_int_bmux[23]), .DFTRAMBYP(1'b0), .mem_path(mem_path[23]), .XQ(XQ|XD_int[23]), .Q(Q_int[23]));
  datapath_latch_tsmc16_1rw_256_64b uDQ24 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[23]), .D(D_int_bmux[24]), .DFTRAMBYP(1'b0), .mem_path(mem_path[24]), .XQ(XQ|XD_int[24]), .Q(Q_int[24]));
  datapath_latch_tsmc16_1rw_256_64b uDQ25 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[24]), .D(D_int_bmux[25]), .DFTRAMBYP(1'b0), .mem_path(mem_path[25]), .XQ(XQ|XD_int[25]), .Q(Q_int[25]));
  datapath_latch_tsmc16_1rw_256_64b uDQ26 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[25]), .D(D_int_bmux[26]), .DFTRAMBYP(1'b0), .mem_path(mem_path[26]), .XQ(XQ|XD_int[26]), .Q(Q_int[26]));
  datapath_latch_tsmc16_1rw_256_64b uDQ27 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[26]), .D(D_int_bmux[27]), .DFTRAMBYP(1'b0), .mem_path(mem_path[27]), .XQ(XQ|XD_int[27]), .Q(Q_int[27]));
  datapath_latch_tsmc16_1rw_256_64b uDQ28 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[27]), .D(D_int_bmux[28]), .DFTRAMBYP(1'b0), .mem_path(mem_path[28]), .XQ(XQ|XD_int[28]), .Q(Q_int[28]));
  datapath_latch_tsmc16_1rw_256_64b uDQ29 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[28]), .D(D_int_bmux[29]), .DFTRAMBYP(1'b0), .mem_path(mem_path[29]), .XQ(XQ|XD_int[29]), .Q(Q_int[29]));
  datapath_latch_tsmc16_1rw_256_64b uDQ30 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[29]), .D(D_int_bmux[30]), .DFTRAMBYP(1'b0), .mem_path(mem_path[30]), .XQ(XQ|XD_int[30]), .Q(Q_int[30]));
  datapath_latch_tsmc16_1rw_256_64b uDQ31 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[30]), .D(D_int_bmux[31]), .DFTRAMBYP(1'b0), .mem_path(mem_path[31]), .XQ(XQ|XD_int[31]), .Q(Q_int[31]));
  datapath_latch_tsmc16_1rw_256_64b uDQ32 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[33]), .D(D_int_bmux[32]), .DFTRAMBYP(1'b0), .mem_path(mem_path[32]), .XQ(XQ|XD_int[32]), .Q(Q_int[32]));
  datapath_latch_tsmc16_1rw_256_64b uDQ33 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[34]), .D(D_int_bmux[33]), .DFTRAMBYP(1'b0), .mem_path(mem_path[33]), .XQ(XQ|XD_int[33]), .Q(Q_int[33]));
  datapath_latch_tsmc16_1rw_256_64b uDQ34 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[35]), .D(D_int_bmux[34]), .DFTRAMBYP(1'b0), .mem_path(mem_path[34]), .XQ(XQ|XD_int[34]), .Q(Q_int[34]));
  datapath_latch_tsmc16_1rw_256_64b uDQ35 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[36]), .D(D_int_bmux[35]), .DFTRAMBYP(1'b0), .mem_path(mem_path[35]), .XQ(XQ|XD_int[35]), .Q(Q_int[35]));
  datapath_latch_tsmc16_1rw_256_64b uDQ36 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[37]), .D(D_int_bmux[36]), .DFTRAMBYP(1'b0), .mem_path(mem_path[36]), .XQ(XQ|XD_int[36]), .Q(Q_int[36]));
  datapath_latch_tsmc16_1rw_256_64b uDQ37 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[38]), .D(D_int_bmux[37]), .DFTRAMBYP(1'b0), .mem_path(mem_path[37]), .XQ(XQ|XD_int[37]), .Q(Q_int[37]));
  datapath_latch_tsmc16_1rw_256_64b uDQ38 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[39]), .D(D_int_bmux[38]), .DFTRAMBYP(1'b0), .mem_path(mem_path[38]), .XQ(XQ|XD_int[38]), .Q(Q_int[38]));
  datapath_latch_tsmc16_1rw_256_64b uDQ39 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[40]), .D(D_int_bmux[39]), .DFTRAMBYP(1'b0), .mem_path(mem_path[39]), .XQ(XQ|XD_int[39]), .Q(Q_int[39]));
  datapath_latch_tsmc16_1rw_256_64b uDQ40 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[41]), .D(D_int_bmux[40]), .DFTRAMBYP(1'b0), .mem_path(mem_path[40]), .XQ(XQ|XD_int[40]), .Q(Q_int[40]));
  datapath_latch_tsmc16_1rw_256_64b uDQ41 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[42]), .D(D_int_bmux[41]), .DFTRAMBYP(1'b0), .mem_path(mem_path[41]), .XQ(XQ|XD_int[41]), .Q(Q_int[41]));
  datapath_latch_tsmc16_1rw_256_64b uDQ42 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[43]), .D(D_int_bmux[42]), .DFTRAMBYP(1'b0), .mem_path(mem_path[42]), .XQ(XQ|XD_int[42]), .Q(Q_int[42]));
  datapath_latch_tsmc16_1rw_256_64b uDQ43 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[44]), .D(D_int_bmux[43]), .DFTRAMBYP(1'b0), .mem_path(mem_path[43]), .XQ(XQ|XD_int[43]), .Q(Q_int[43]));
  datapath_latch_tsmc16_1rw_256_64b uDQ44 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[45]), .D(D_int_bmux[44]), .DFTRAMBYP(1'b0), .mem_path(mem_path[44]), .XQ(XQ|XD_int[44]), .Q(Q_int[44]));
  datapath_latch_tsmc16_1rw_256_64b uDQ45 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[46]), .D(D_int_bmux[45]), .DFTRAMBYP(1'b0), .mem_path(mem_path[45]), .XQ(XQ|XD_int[45]), .Q(Q_int[45]));
  datapath_latch_tsmc16_1rw_256_64b uDQ46 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[47]), .D(D_int_bmux[46]), .DFTRAMBYP(1'b0), .mem_path(mem_path[46]), .XQ(XQ|XD_int[46]), .Q(Q_int[46]));
  datapath_latch_tsmc16_1rw_256_64b uDQ47 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[48]), .D(D_int_bmux[47]), .DFTRAMBYP(1'b0), .mem_path(mem_path[47]), .XQ(XQ|XD_int[47]), .Q(Q_int[47]));
  datapath_latch_tsmc16_1rw_256_64b uDQ48 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[49]), .D(D_int_bmux[48]), .DFTRAMBYP(1'b0), .mem_path(mem_path[48]), .XQ(XQ|XD_int[48]), .Q(Q_int[48]));
  datapath_latch_tsmc16_1rw_256_64b uDQ49 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[50]), .D(D_int_bmux[49]), .DFTRAMBYP(1'b0), .mem_path(mem_path[49]), .XQ(XQ|XD_int[49]), .Q(Q_int[49]));
  datapath_latch_tsmc16_1rw_256_64b uDQ50 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[51]), .D(D_int_bmux[50]), .DFTRAMBYP(1'b0), .mem_path(mem_path[50]), .XQ(XQ|XD_int[50]), .Q(Q_int[50]));
  datapath_latch_tsmc16_1rw_256_64b uDQ51 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[52]), .D(D_int_bmux[51]), .DFTRAMBYP(1'b0), .mem_path(mem_path[51]), .XQ(XQ|XD_int[51]), .Q(Q_int[51]));
  datapath_latch_tsmc16_1rw_256_64b uDQ52 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[53]), .D(D_int_bmux[52]), .DFTRAMBYP(1'b0), .mem_path(mem_path[52]), .XQ(XQ|XD_int[52]), .Q(Q_int[52]));
  datapath_latch_tsmc16_1rw_256_64b uDQ53 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[54]), .D(D_int_bmux[53]), .DFTRAMBYP(1'b0), .mem_path(mem_path[53]), .XQ(XQ|XD_int[53]), .Q(Q_int[53]));
  datapath_latch_tsmc16_1rw_256_64b uDQ54 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[55]), .D(D_int_bmux[54]), .DFTRAMBYP(1'b0), .mem_path(mem_path[54]), .XQ(XQ|XD_int[54]), .Q(Q_int[54]));
  datapath_latch_tsmc16_1rw_256_64b uDQ55 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[56]), .D(D_int_bmux[55]), .DFTRAMBYP(1'b0), .mem_path(mem_path[55]), .XQ(XQ|XD_int[55]), .Q(Q_int[55]));
  datapath_latch_tsmc16_1rw_256_64b uDQ56 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[57]), .D(D_int_bmux[56]), .DFTRAMBYP(1'b0), .mem_path(mem_path[56]), .XQ(XQ|XD_int[56]), .Q(Q_int[56]));
  datapath_latch_tsmc16_1rw_256_64b uDQ57 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[58]), .D(D_int_bmux[57]), .DFTRAMBYP(1'b0), .mem_path(mem_path[57]), .XQ(XQ|XD_int[57]), .Q(Q_int[57]));
  datapath_latch_tsmc16_1rw_256_64b uDQ58 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[59]), .D(D_int_bmux[58]), .DFTRAMBYP(1'b0), .mem_path(mem_path[58]), .XQ(XQ|XD_int[58]), .Q(Q_int[58]));
  datapath_latch_tsmc16_1rw_256_64b uDQ59 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[60]), .D(D_int_bmux[59]), .DFTRAMBYP(1'b0), .mem_path(mem_path[59]), .XQ(XQ|XD_int[59]), .Q(Q_int[59]));
  datapath_latch_tsmc16_1rw_256_64b uDQ60 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[61]), .D(D_int_bmux[60]), .DFTRAMBYP(1'b0), .mem_path(mem_path[60]), .XQ(XQ|XD_int[60]), .Q(Q_int[60]));
  datapath_latch_tsmc16_1rw_256_64b uDQ61 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[62]), .D(D_int_bmux[61]), .DFTRAMBYP(1'b0), .mem_path(mem_path[61]), .XQ(XQ|XD_int[61]), .Q(Q_int[61]));
  datapath_latch_tsmc16_1rw_256_64b uDQ62 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(Q_int[63]), .D(D_int_bmux[62]), .DFTRAMBYP(1'b0), .mem_path(mem_path[62]), .XQ(XQ|XD_int[62]), .Q(Q_int[62]));
  datapath_latch_tsmc16_1rw_256_64b uDQ63 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(1'b0), .SI(1'b0), .D(D_int_bmux[63]), .DFTRAMBYP(1'b0), .mem_path(mem_path[63]), .XQ(XQ|XD_int[63]|1'b0), .Q(Q_int[63]));
...
`endif
  ...
  reg NOT_CEN, NOT_GWEN, NOT_A7, NOT_A6, NOT_A5, NOT_A4, NOT_A3, NOT_A2, NOT_A1, NOT_A0;
  reg NOT_D63, NOT_D62, NOT_D61, NOT_D60, NOT_D59, NOT_D58, NOT_D57, NOT_D56, NOT_D55;
  reg NOT_D54, NOT_D53, NOT_D52, NOT_D51, NOT_D50, NOT_D49, NOT_D48, NOT_D47, NOT_D46;
 ...
 wire  dRET1N;
  ...
  buf B98(D_[23],dD[23]);
  buf B99(D_[24],dD[24]);
  buf B100(D_[25],dD[25]);
  buf B101(D_[26],dD[26]);
  buf B102(D_[27],dD[27]);
  buf B103(D_[28],dD[28]);
  buf B104(D_[29],dD[29]);
  buf B105(D_[30],dD[30]);
  buf B106(D_[31],dD[31]);
  buf B107(D_[32],dD[32]);
  buf B108(D_[33],dD[33]);
  buf B109(D_[34],dD[34]);
  buf B110(D_[35],dD[35]);
  buf B111(D_[36],dD[36]);
  buf B112(D_[37],dD[37]);
  buf B113(D_[38],dD[38]);
  buf B114(D_[39],dD[39]);
  buf B115(D_[40],dD[40]);
  buf B116(D_[41],dD[41]);
  buf B117(D_[42],dD[42]);
  buf B118(D_[43],dD[43]);
  buf B119(D_[44],dD[44]);
  buf B120(D_[45],dD[45]);
  buf B121(D_[46],dD[46]);
  buf B122(D_[47],dD[47]);
  buf B123(D_[48],dD[48]);
  buf B124(D_[49],dD[49]);
  buf B125(D_[50],dD[50]);
  buf B126(D_[51],dD[51]);
  buf B127(D_[52],dD[52]);
  buf B128(D_[53],dD[53]);
  buf B129(D_[54],dD[54]);
  buf B130(D_[55],dD[55]);
  buf B131(D_[56],dD[56]);
  buf B132(D_[57],dD[57]);
  buf B133(D_[58],dD[58]);
  buf B134(D_[59],dD[59]);
  buf B135(D_[60],dD[60]);
  buf B136(D_[61],dD[61]);
  buf B137(D_[62],dD[62]);
  buf B138(D_[63],dD[63]);
  buf B139(STOV_, dSTOV);
  buf B140(EMA_[0],dEMA[0]);
  buf B141(EMA_[1],dEMA[1]);
  buf B142(EMA_[2],dEMA[2]);
  buf B143(EMAW_[0],dEMAW[0]);
  buf B144(EMAW_[1],dEMAW[1]);
  buf B145(EMAS_, dEMAS);
  buf B146(RET1N_, dRET1N);
...
`endif
 ...
 wire  CLK_;
  ...
  buf B285(D_[63], D[63]);
  buf B286(STOV_, STOV);
  buf B287(EMA_[0], EMA[0]);
  buf B288(EMA_[1], EMA[1]);
  buf B289(EMA_[2], EMA[2]);
  buf B290(EMAW_[0], EMAW[0]);
  buf B291(EMAW_[1], EMAW[1]);
  buf B292(EMAS_, EMAS);
  buf B293(RET1N_, RET1N);
...
`endif
`timescale 1ns/1ps
module tsmc16_1rw_256_64b_error_injection (Q_out, Q_in, CLK, A, CEN, WEN, GWEN);
   output [63:0] Q_out;
   input [63:0] Q_in;
   input CLK;
   input [7:0] A;
